...
Though I'm using [custom shortcuts](packages/which-key.el) and you can toggle [evil mode](https://github.com/emacs-evil/evil) (<kbd>C-c</kbd> <kbd>t</kbd> <kbd>e</kbd>), most of my bindings are set to default.  
